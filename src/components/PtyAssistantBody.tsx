        ...
        p.kind === 'diff' ? (
          ...
          >
            ...
            <p className="m-0 px-3 py-2 text-[11px] leading-snug text-amber-950 border-b border-amber-100/80 bg-amber-50/95">
              This is what the terminal is showing — it was not sent from the dashboard. Type{' '}
              <kbd className="px-1 py-0.5 rounded bg-amber-200/80 text-[10px] font-mono">1</kbd> then Enter in{' '}
              <strong>Logon</strong> or use <strong>Reply below</strong> so the real PTY receives your choice.
            </p>
